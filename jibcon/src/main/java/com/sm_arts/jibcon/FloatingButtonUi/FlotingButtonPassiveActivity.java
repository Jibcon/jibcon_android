...
public class FlotingButtonPassiveActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabItem1=findViewById(R.id.fab_action_1_cheatkey_passive);
        fabItem1.setVisibility(View.INVISIBLE);
        fabItem2=(TextView)findViewById(R.id.Txt_floating_cheatkey_passive);


        fab=(ImageButton)findViewById(R.id.fab_cheatkey_passive);
